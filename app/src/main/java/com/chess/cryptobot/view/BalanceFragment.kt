...
class BalanceFragment : MainFragment<BalanceAdapter.BalanceViewHolder>() {
    override fun onCreateView(
        ...
        val view = super.onCreateView(inflater, container, savedInstanceState)
            ?: throw InitializationException("BalanceFragment view")
        initAddButton(view)
        initSyncButton(view)
        initBalanceStatus()
    ...
    private fun initAddButton(view: View) {
        val addBalanceButton: FloatingActionButton = view.findViewById(R.id.add_fab)
    ...
    private fun initSyncButton(view: View) {
        ...
        syncBalanceButton.setOnClickListener {
            ...
            val alertDialog = AlertDialog.Builder(requireContext())
                ...
                .setPositiveButton("Yes") { _: DialogInterface?, _: Int ->
                    ...
                    if (activity != null) {
                        val coinNames = holder.prefs.items ?: return@setPositiveButton
                        ...
                        WorkManager.getInstance(this.requireContext()).enqueue(balanceSyncWorker)
                    }
                }
    ...
    public override fun initRecyclerView(view: View): RecyclerView {
        ...
        val itemTouchHelper =
            ItemTouchHelper(SwipeBalanceCallback((holder as BalanceHolder), activity))
